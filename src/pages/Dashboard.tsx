    ...
    <div className="max-w-7xl mx-auto px-4 pt-12 pb-24 space-y-24">
      ...
      <section className="text-center max-w-4xl mx-auto space-y-8">
        ...
        <motion.p 
          ...
          className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium"
        >
          RxDecoder uses advanced AI to instantly translate complex medical prescriptions and lab reports into simple, actionable insights. 🧠✨
        </motion.p>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        >
          <Link to="/prescription" className="block h-full relative group">
            <div className="absolute inset-0 bg-blue-100 dark:bg-blue-900/30 rounded-[2rem] transform translate-y-2 translate-x-2 group-hover:translate-y-4 group-hover:translate-x-4 transition-transform duration-300" />
            <div className="relative h-full bg-white dark:bg-slate-900 p-10 rounded-[2rem] border-2 border-slate-900 dark:border-slate-700 flex flex-col items-start hover:-translate-y-2 hover:-translate-x-2 transition-transform duration-300">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/50 rounded-2xl flex items-center justify-center mb-8 border border-blue-200 dark:border-blue-800">
                <Pill className="w-8 h-8 text-blue-600 dark:text-blue-400" />
              </div>
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Medicine 💊</h2>
        ...
        >
          <Link to="/lab-report" className="block h-full relative group">
            <div className="absolute inset-0 bg-emerald-100 dark:bg-emerald-900/30 rounded-[2rem] transform translate-y-2 -translate-x-2 group-hover:translate-y-4 group-hover:-translate-x-4 transition-transform duration-300" />
            <div className="relative h-full bg-white dark:bg-slate-900 p-10 rounded-[2rem] border-2 border-slate-900 dark:border-slate-700 flex flex-col items-start hover:-translate-y-2 hover:translate-x-2 transition-transform duration-300">
              <div className="w-16 h-16 bg-emerald-100 dark:bg-emerald-900/50 rounded-2xl flex items-center justify-center mb-8 border border-emerald-200 dark:border-emerald-800">
                <Activity className="w-8 h-8 text-emerald-600 dark:text-emerald-400" />
              </div>
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Lab Reports 🔬</h2>
              <p className="text-slate-600 dark:text-slate-400 font-medium mb-8 flex-1">
      ...
      {/* About & Trust */}
      <section className="bg-slate-900 rounded-[3rem] text-white p-12 md:p-20 overflow-hidden relative">
        <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none">
          <ShieldCheck className="w-64 h-64" />
        </div>
        <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h3 className="text-4xl font-black">Why RxDecoder? 🛡️</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">support@rxdecoder.ai</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center">
